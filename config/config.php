...
|
*/
$config['botToken'] = "6075581085:AAGrZDXYhNPoFE_jjHKqzFiuSAwK071b080";
...
|
*/
$config['db']['hostname'] =  "sql208.byethost10.com";
$config['db']['username'] =  "'b10_34138024";
$config['db']['password'] =  "Fahad@@@11";
$config['db']['database'] =  "b10_34138024_localhost";
